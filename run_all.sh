...
./run_champsim.sh bullseye-no-no-no-no-lru-1core 1 10 403.gcc-16B.champsimtrace.xz
./run_champsim.sh bullseye-no-no-no-no-lru-1core 1 10 434.zeusmp-10B.champsimtrace.xz
./run_champsim.sh bullseye-no-no-no-no-lru-1core 1 10 450.soplex-92B.champsimtrace.xz
